...
$numNoBrands=$res=CIBlockElement::GetList(array(), array('IBLOCK_ID'=>26, 'PROPERTY_BRAND'=>false), array());
echo $numNoBrands.'<br>';exit;
...
endwhile;
echo sizeof($arProdsFromSite).'<br>';
//exit;
//$arOffer=$res->GetNext();
//pr($arProdsFromSite);
