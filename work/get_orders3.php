...
function sendOrder2WSDL2($order_id, $arFields, $arOrder, $isnew) {
	...
	$result=pr($obTest, true);
	file_put_contents($_SERVER["DOCUMENT_ROOT"].'/work/zakaz.xml', $s);
	file_put_contents($_SERVER["DOCUMENT_ROOT"].'/work/zakaz.xml', $result, FILE_APPEND);

}
sendOrder2WSDL2(108, array(), array(), false);
