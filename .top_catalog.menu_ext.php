<?
	...
	$db_sec = CIBlockSection::GetList(Array(), Array('IBLOCK_ID'=>26, array("LOGIC"=>"OR", 'CNT_ACTIVE'=>'Y','SECTION_ID'=>5338 ), 'GLOBAL_ACTIVE'=>'Y'), true, array('SECTION_PAGE_URL', 'IBLOCK_SECTION_ID'));																
