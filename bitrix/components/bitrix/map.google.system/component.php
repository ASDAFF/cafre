...
if (!defined('BX_GMAP_SCRIPT_LOADED'))
{
	...
	if ($arParams['DEV_MODE'] != 'Y')
	{
		...
		$APPLICATION->AddHeadString('<script src="'.$scheme.'://maps.google.com/maps/api/js?key=AIzaSyDcRvC__j3tSJLDcKYiPbvg4z75quenpaA&sensor=false&language='.LANGUAGE_ID.'" charset="utf-8"></script>');
