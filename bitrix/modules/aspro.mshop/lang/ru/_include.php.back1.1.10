...
$MESS["MAX_AMOUNT"] = "Значение остатака, для которого, выводится выражение \"<i>много</i>\" (больше, чем)";
$MESS["MIN_AMOUNT"] = "Значение остатака, для которого, выводится выражение \"<i>мало</i>\" (меньше, чем)";
...
$MESS["GOOGLE_COUNTER_TITLE"] = "Код счетчика в google analytics";
