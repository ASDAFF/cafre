...
class CIMContactList extends CAllIMContactList
{
	public static function SetRecent($arParams)
	{
		...
		if (isset($arParams['CHAT_TYPE']) && in_array($arParams['CHAT_TYPE'], Array(IM_MESSAGE_PUBLIC, IM_MESSAGE_CHAT)))
		{
		...
		$isChat = in_array($chatType, Array(IM_MESSAGE_PUBLIC, IM_MESSAGE_CHAT));
