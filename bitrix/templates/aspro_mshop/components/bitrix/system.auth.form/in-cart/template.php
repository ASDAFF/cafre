...
<a name="fauth"></a>
<a id="showauth" href="javascript:void(0);" style="border-bottom:1px dashed #eb5470">¬ход дл€ зарегистрированных пользователей</a>
	<div id="ajax_auth" style="display:none;margin-top:5px"> <!-- display:none;  -->
		<div class="auth_wrapp form-block">
			<div class="wrap_md">
				<div class="main_info iblock" style="border:none">
					<div class="form-wr">
						<?if( $arResult["ERROR"] ){?>
						...
						<form id="avtorization-form" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arParams["AUTH_URL"]?>?login=yes">
							...
							<div class=""> <!-- but-r cleaarboth -->
									<a class="forgot" style="display:inline-block;padding:5px" href="<?=SITE_DIR?>auth/forgot-password/" tabindex="3"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
										<input type="checkbox" style="width:10px" id="USER_REMEMBER_frm" name="USER_REMEMBER" value="Y" tabindex="5"/>
								...
								<div class="buttons" style="margin-top:5px">
									<button type="submit" class="button vbig_btn wides" name="Login" value="" tabindex="4">
										<span><?=GetMessage("AUTH_LOGIN_BUTTON2")?></span>
									</button>
								</div>
						</form>
					</div>
