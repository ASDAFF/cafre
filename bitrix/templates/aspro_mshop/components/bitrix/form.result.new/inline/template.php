...
<div class="tex_check_politik2">
	...
	<div class="form_footer">
		...
		$(document).ready(function(){
            $('form[name=CALLBACK]').attr("onsubmit","yaCounter37955450.reachGoal('call'); ga('send', 'event', 'call', 'submit'); return true;");  
            $('form[name=ASK]').attr("onsubmit","yaCounter37955450.reachGoal('ask'); ga('send', 'event', 'call', 'submit'); return true;");   
