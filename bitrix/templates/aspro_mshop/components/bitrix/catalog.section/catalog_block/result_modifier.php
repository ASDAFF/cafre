	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if ($arItem['CATALOG'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
		{
			if ('TYPE_1' == $arParams['TYPE_SKU'] && $arParams['DISPLAY_TYPE'] !='table')
			{
				...
				{
					/*$arOffer["CATALOG_QUANTITY"] = 9999;
					$arOffer["~CATALOG_QUANTITY"] = 9999;
					$arOffer["CAN_BUY"] = "Y";
					$arOffer["CATALOG_CAN_BUY_ZERO"] = "Y";
					$arOffer["~CATALOG_CAN_BUY_ZERO"] = "Y";
					$arOffer["CATALOG_AVAILABLE"] = "Y";
					$arOffer["~CATALOG_AVAILABLE"] = "N";
					$arOffer["CATALOG_SUBSCRIBE"] = "Y";
	$arOffer["CATALOG_QUANTITY_RESERVED"] = 0;
    $arOffer["~CATALOG_QUANTITY_RESERVED"] = 0;
    $arOffer["CATALOG_QUANTITY_TRACE"] = "N";
    $arOffer["~CATALOG_QUANTITY_TRACE"] = "N";
    $arOffer["CATALOG_QUANTITY_TRACE_ORIG"] = "D";
    $arOffer["~CATALOG_QUANTITY_TRACE_ORIG"] = "D";
    $arOffer["CATALOG_CAN_BUY_ZERO"] = "Y";
    $arOffer["~CATALOG_CAN_BUY_ZERO"] = "Y";
    $arOffer["CATALOG_CAN_BUY_ZERO_ORIG"] = "D";
    $arOffer["~CATALOG_CAN_BUY_ZERO_ORIG"] = "D";
   $arOffer["CATALOG_NEGATIVE_AMOUNT_TRACE"] = "Y";
    $arOffer["~CATALOG_NEGATIVE_AMOUNT_TRACE"] = "Y";
    $arOffer["CATALOG_NEGATIVE_AMOUNT_ORIG"] = "D";
    $arOffer["~CATALOG_NEGATIVE_AMOUNT_ORIG"] = "D";
    $arOffer["CATALOG_SUBSCRIBE"] = "Y";
    $arOffer["~CATALOG_SUBSCRIBE"] = "N";
    $arOffer["CATALOG_SUBSCRIBE_ORIG"] = "D";
    $arOffer["~CATALOG_SUBSCRIBE_ORIG"] = "D";
    $arOffer["CATALOG_AVAILABLE"] = "Y";
    $arOffer["~CATALOG_AVAILABLE"] = "Y";
	$arOffer["CATALOG_VAT_INCLUDED"] = "N";
    $arOffer["~CATALOG_VAT_INCLUDED"] = "N";
    $arOffer["CATALOG_PRICE_TYPE"] = "S";
    $arOffer["~CATALOG_PRICE_TYPE"] = "S";
    $arOffer["CATALOG_RECUR_SCHEME_TYPE"] = "D";
    $arOffer["~CATALOG_RECUR_SCHEME_TYPE"] = "D";
    $arOffer["CATALOG_RECUR_SCHEME_LENGTH"] = 0;
    $arOffer["~CATALOG_RECUR_SCHEME_LENGTH"] = 0;
    $arOffer["CATALOG_WITHOUT_ORDER"] = "N";
    $arOffer["~CATALOG_WITHOUT_ORDER"] = "N";
    $arOffer["CATALOG_SELECT_BEST_PRICE"] = "Y";
    $arOffer["~CATALOG_SELECT_BEST_PRICE"] = "Y";
					$arOffer["~CATALOG_TYPE"] = 1;
					echo '<pre>';
					print_r($arOffer);
					echo '</pre>';*/
