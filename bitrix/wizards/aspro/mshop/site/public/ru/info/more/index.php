...
$APPLICATION->SetTitle("¬озможности");
?>
<div class="wrap_md_row">
	<div class="iblock md-33">
		<h3><a href="#SITE_DIR#info/more/typograpy/">ќформление</a></h3>
		<ul>
	...
	<div class="iblock md-33">
		<h3><a href="#SITE_DIR#info/more/buttons/"> нопки</a></h3>
		<ul>
	...
	<div class="iblock md-33">
		<h3><a href="#SITE_DIR#info/more/elements/">Ёлементы</a></h3>
		<ul>
			<li>табы</li>
			<li>формы</li>
			<li>аккордионы</li>
			<li>постранична€ навигации€</li>
		</ul>
	</div>
</div>
